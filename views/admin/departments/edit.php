    ...
    <div class="col-md-6">
        <div class="card shadow">
            <div class="card-header bg-warning">
                <h4 class="mb-0">ویرایش پارلمان</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="/admin/departments/<?= $department['id'] ?>/update">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?= e($department['name']) ?>" required>
                    </div>
